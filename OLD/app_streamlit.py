...
from demf_core import DEMFConfig, run_detect_only, run_train_and_detect
...
# Tabs
overview_tab, alerts_tab, user_tab, analytics_tab, model_tab = st.tabs(
    ["Overview", "Alert Explorer", "User Investigation", "Behavior Analytics", "Model & Config"]
)
